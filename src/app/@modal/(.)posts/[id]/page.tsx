        ...
        <div className="rounded-xl overflow-hidden">
            <div>
                ...
                <div className="px-4 pt-2 flex flex-col gap-1">
                    ...
                    <p className="text-sm text-background-400 flex flex-row gap-1 items-center"><Link href={`/users/${post.createdBy}`} className="flex flex-row gap-1 items-center"><Image src={`https://a.lisek.world/${post.createdBy}`} width={32} height={32} alt={post.username} className="rounded-full"/>{post.username}</Link></p>
